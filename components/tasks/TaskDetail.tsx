            ...
            <div className="bg-[#fdfcf9] border border-[#e5dec9] rounded-[3rem] w-full max-w-5xl max-h-[90vh] overflow-hidden flex flex-col shadow-2xl animate-in zoom-in-95 duration-500">
                ...
                <div className="p-8 border-b border-[#f7f3ed] flex items-center justify-between bg-[#f7f3ed]/30">
                    <div className="flex items-center gap-4">
                        <span className={`px-4 py-1.5 rounded-full text-[9px] font-semibold uppercase tracking-widest border ${statusColors[status] || 'bg-white text-[#78716c] border-[#e5dec9]'}`}>
                            {status.replace('_', ' ')}
                        </span>
                ...
                <div className="flex-1 overflow-y-auto flex flex-col lg:flex-row">
                    ...
                    <div className="flex-1 p-10 space-y-12 border-b lg:border-b-0 lg:border-r border-[#f7f3ed]">
                        <div className="space-y-6">
                            <h1 className="text-4xl font-semibold text-[#1c1917] tracking-tight leading-tight uppercase">{task.title}</h1>
                            <div className="flex flex-wrap items-center gap-10">
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 rounded-xl bg-[#f7f3ed] border border-[#e5dec9] flex items-center justify-center text-sm font-semibold text-[#1c1917]">
                    ...
                    <div className="w-full lg:w-96 bg-[#f7f3ed]/20 flex flex-col">
                        ...
                        <div className="p-8 bg-[#f7f3ed]/50 border-t border-[#e5dec9] flex flex-col gap-4">
                            <button className="btn-secondary w-full py-4 text-[10px] font-semibold uppercase tracking-[0.2em] bg-white">
                                Adjust Priority
                            </button>
