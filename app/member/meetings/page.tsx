        ...
        <div className="space-y-8">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div className="space-y-1">
                    <h2 className="text-sm font-bold text-primary-500 uppercase tracking-widest">Connect</h2>
                    <h1 className="text-4xl font-bold text-slate-900 tracking-tight">Upcoming Syncs</h1>
            ...
            <div className="card p-8 shadow-sm">
                <div className="flex items-center gap-4 mb-8">
                    <div className="p-3 bg-primary-50 text-primary-500 rounded-2xl border border-primary-100 shadow-sm shadow-primary-500/5">
